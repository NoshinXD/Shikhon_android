...
//   const topicTempFetchaddr = fetchAddress + "course/chapter/topic/all";
//   // console.log(tempFetchaddr);
//   const topicAddr = `${topicTempFetchaddr}?courseID=${encodeURIComponent(param.courseID)}&chapterNo=${encodeURIComponent(param.chapterNo)}`;

//   const [topicList, setTopicList] = useState([]);
//   const [dropOpen, setDropOpen] = useState(false);
//   // var topicList = [];
//   const getTopic = async() => {
//     await fetch(topicAddr)
//     .then((res) => res.json())
//     // .then((res) => res.text())
//     .then(async (data) => {
//       try {
...
//         console.log("The error is: ", e);
//       }
//       // console.log(data.topicArr.topicList[0].topicName)
//       setTopicList(data.topicArr.topicList);

//       // return data.topicArr.topicList;
...
//         newArrayOfObj.push({label: topicList[i].topicName, value: topicList[i].topicName})
//       }
...
//           console.log("The error is: ", e);
//         }
//         console.log(data.topicArr.topicList[0]);
//       });
//     setShowSubmit(0);
//     setTopicName("");
//     setNote("");
...
//       <View style={styles.content}>
//       <View>
//         <TouchableOpacity onPress={() => printInfo()} style={styles.addButton}>
//           <View style={styles.addViewButton}>
//             <Text style={styles.addButtonText}>show topics</Text>
//           </View>
//         </TouchableOpacity>
//       </View>
//         <View>
